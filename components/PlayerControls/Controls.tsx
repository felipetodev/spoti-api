...
export const SkipBackIcon: React.FC<any> = () => (
...
export const PlayButtonIcon: React.FC<any> = (props) => (
  <Stack
    as="svg"
    fill="#fff"
    role="img"
...
export const PauseButtonIcon: React.FC<any> = (props) => (
  <Stack
    as="svg"
    fill="#fff"
    role="img"
...
export const FullScreenIcon: React.FC<any> = () => (
  <svg fill="#fff" role="img" height="16" width="16" viewBox="0 0 16 16">
